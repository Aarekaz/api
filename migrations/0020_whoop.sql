...
CREATE TABLE IF NOT EXISTS whoop_sleeps (
  ...
  stage_in_bed_milliseconds INTEGER,
  stage_no_data_milliseconds INTEGER,
  ...
  sleep_need_recent_strain_milliseconds INTEGER,
  sleep_need_recent_nap_milliseconds INTEGER,
